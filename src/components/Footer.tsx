        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Experienced IT Support professional with expertise in network
            ...
            <div className="flex space-x-4">
              {[
                ...
                <a
                  ...
                  className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-gray-400 hover:text-white hover:bg-indigo-600 transition-all duration-200 hover-lift"
                  title={social.name}
                >
                  <svg
                    className="w-5 h-5"
